...
export const dashboardStyles = {
  container: "min-h-screen p-4 md:p-6 bg-white",
...
export const incomeStyles = {
  ...
  filterSelect: "appearance-none bg-white border border-gray-300 rounded-lg pl-3 pr-8 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent w-full text-gray-900",
...
export const expensePageStyles = {
  container: "space-y-6 max-w-7xl bg-white",
...
export const profileStyles = {
  ...
  cardTitle: "text-xl font-black text-gray-900 flex items-center gap-3",
  icon: "w-6 h-6 text-teal-600 p-1.5 bg-teal-50 rounded-lg",
  label: "block text-xs font-bold text-gray-400 uppercase tracking-widest ml-1 mb-2",
  input: "w-full bg-gray-50 border-2 border-transparent rounded-2xl px-5 py-4 text-gray-700 font-medium transition-all duration-200 focus:bg-white focus:border-gray-100 focus:ring-4 focus:ring-teal-500/10 outline-none",
  inputWithError: "w-full bg-gray-50 border-2 border-transparent rounded-2xl px-5 py-4 text-gray-700 font-medium transition-all duration-200 focus:bg-white focus:border-gray-100 focus:ring-4 focus:ring-teal-500/10 outline-none",
  buttonPrimary: "flex-1 bg-gradient-to-r from-teal-500 to-emerald-600 text-white py-4 rounded-2xl font-black shadow-lg hover:shadow-xl transition-all active:scale-95",
  buttonSecondary: "flex-1 py-4 border-2 border-gray-200 text-gray-600 rounded-2xl font-bold hover:bg-gray-100 transition-all",
  editButton: "px-4 py-2 bg-white text-teal-600 rounded-xl font-bold text-sm shadow-sm hover:shadow-md transition-all border border-teal-50",
  changeButton: "px-4 py-2 bg-teal-50 text-teal-600 rounded-xl font-bold text-sm hover:bg-teal-100 transition-all",
  securityItem: "flex items-center justify-between p-5 bg-white rounded-2xl border border-gray-100 hover:border-teal-100 transition-all",
  securityText: "font-bold text-gray-700",
  modalContent: "relative bg-white rounded-[2.5rem] w-full max-w-md shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] border border-white overflow-hidden",
  modalHeader: "p-8 pb-6 bg-gradient-to-br from-teal-50 to-emerald-50",
  modalTitle: "text-2xl font-black text-gray-900 leading-tight",
  passwordLabel: "block text-xs font-bold text-gray-400 uppercase tracking-widest ml-1 mb-2",
  passwordContainer: "relative group",
  passwordToggle: "absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-teal-600 transition-colors",
  errorText: "mt-1.5 text-xs font-bold text-red-500 ml-1"
};
...
export const modalStyles = {
  ...
  input: (ringColor) => `w-full border border-gray-200 bg-white rounded-lg px-4 py-2 focus:outline-none focus:ring-2 ${ringColor} text-gray-900`,
...
export const loginStyles = {
  pageContainer: "min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-rose-200 to-emerald-50",
  cardContainer: "w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden",
  header: "bg-radial from-yellow-500 to-red-500 p-6 text-center",
  ...
  input: "w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-300 focus:border-teal-500 text-gray-900",
  passwordInput: "w-full pl-10 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-300 focus:border-teal-500 text-gray-900",
  ...
  checkbox: "w-4 h-4 text-teal-600 border-gray-300 rounded focus:ring-green-500 cursor-pointer",
  checkboxLabel: "ml-2 block text-sm text-gray-700",
  button: "w-full bg-gradient-to-r from-teal-500 to-emerald-600 text-white py-3 rounded-xl font-medium shadow-md hover:shadow-lg transition-all flex items-center justify-center cursor-pointer",
...
export const navbarStyles = {
  header: "sticky top-0 z-50 bg-white border-b border-gray-100 shadow-sm transition-colors",
  ...
  logoImage: "block w-10 h-10 md:w-12 md:h-12 rounded-xl overflow-hidden shrink-0",
  logoText: "lg:text-3xl md:text-3xl text-2xl text-gray-900 font-[550] lobster-regular",
  userContainer: "relative",
  userButton: "flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-50 transition-colors min-w-0",
  userAvatar: "w-9 h-9 shrink-0 flex items-center justify-center rounded-full bg-gradient-to-br from-teal-600 to-cyan-500 text-white font-bold text-lg",
  statusIndicator: "absolute -bottom-1 -right-1 w-3 h-3 bg-green-500 rounded-full border-2 border-white",
  userTextContainer: "text-left hidden md:block min-w-0",
  ...
  dropdownName: "text-sm text-gray-800 truncate",
...
export const signupStyles = {
  pageContainer: "min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-rose-200 to-emerald-50",
  cardContainer: "w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden",
  header: "bg-radial from-yellow-500 to-red-500 p-6 text-center relative",
  avatar: "w-20 h-20 mx-auto rounded-full bg-white/20 flex items-center justify-center mb-4",
  headerTitle: "text-2xl font-bold text-white",
  headerSubtitle: "text-teal-100 mt-2",
...
export const transactionItemStyles = {
  ...
  input: (hasError, classes) => 
    `w-full bg-white rounded-lg px-3 py-2 focus:outline-none focus:ring-1 ${hasError ? "border-red-500 ring-red-500" : `${classes.border} ${classes.ring}`} text-gray-900`,
  amountInput: (hasError, classes) => 
    `w-full max-w-[120px] bg-white rounded-lg px-3 py-2 focus:outline-none focus:ring-1 ${hasError ? "border-red-500 ring-red-500" : `${classes.border} ${classes.ring}`} text-gray-900`,
...
export const sidebarStyles = {
  ...
  sidebarInner: {
    base: "bg-white border-r border-gray-200 shadow-md h-full flex flex-col transition-colors"
  },
  ...
  userInitials: {
    base: "w-12 h-12 rounded-xl bg-gradient-to-br from-teal-400 to-teal-500 flex items-center justify-center text-white font-bold text-xl"
  },
  menuList: {
    base: "space-y-1 px-2"
  },
  ...
  mobileSidebar: {
    base: "absolute left-0 top-0 bottom-0 w-4/5 max-w-sm bg-white shadow-2xl rounded-r-2xl overflow-hidden transition-colors"
  },
...
export const styles = {
  layout: {
    root: "min-h-screen bg-white transition-colors duration-500",
  ...
  statCards: {
    ...
    card: "bg-white p-5 rounded-2xl shadow-sm border border-gray-100 transition-colors",
    ...
    iconContainer: (color) => `p-2 rounded-lg bg-${color}-100`,
  ...
  cards: {
    base: "bg-white rounded-2xl p-6 shadow-sm border border-gray-100 transition-colors",
